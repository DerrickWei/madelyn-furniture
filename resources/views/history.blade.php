                ...
                <table class="table table-bordered border-primary">
                    ...
                    @foreach ( $orderHistory as $item )
                        <tr style="color: white">
                            ...
                            <td name="model"> {{ $item['GoodsID'] }} </td>
                            <td name="panel"> {{ $item['PanelID'] }} </td>
                            <td name="border"> {{ $item['BorderID'] }} </td>
                            <td name="special_order"> {{ $item['Note'] }} </td>
                            <td name="delivery_date"> {{ $item['DeliveryDate'] }} </td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
            @else
                <h3 style="color: white">No Order</h3>
            @endif
        </div>
    </body>
</html>
